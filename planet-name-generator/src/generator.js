...
const CONSONANTS = {
    ...
    middleCluster: [
        ...
        'fg','fr',
        'gb','gd','gl','gm','gn','gr','gs','gt','gth','gv','gw',
        'hk','hl','hs','ht','hw',
        'kb','kd','kh','kl','km','kn','kr','kt','kth','ktr','kv','ky',
        'lb','lc','lcr','lcy','ld','ldr','lg','lgr','lh','lj','lk','lkr','ll','lm','ln','lp','lph','lr','ls','lt','lth','lv','lw','ly','lyps','lypt','lz',
